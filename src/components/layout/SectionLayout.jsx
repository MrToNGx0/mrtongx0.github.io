...
const SectionLayout = ({ id, title, subtitle, children, hasReadabilityBg = true, className = "" }) => {
  return (
    <section 
      id={id} 
    ...
    >
      ...
      <div className="container mx-auto px-8 md:px-12 lg:px-20 relative z-10 w-full flex flex-col h-full pt-28 pb-32">
